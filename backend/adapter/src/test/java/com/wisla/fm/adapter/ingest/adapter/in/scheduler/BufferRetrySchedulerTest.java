...
import com.wisla.fm.adapter.ingest.adapter.out.persistence.BufferedMessageJpaRepository;
...
import com.wisla.fm.adapter.testsupport.BufferedMessageTestData;
...
class BufferRetrySchedulerTest {
    ...
    @Autowired
    private BufferRetryScheduler bufferRetryScheduler;

    @Autowired
    private BufferedMessageJpaRepository bufferedMessageRepository;

    @Autowired
    private SourceConfigSnapshotJpaRepository sourceConfigSnapshotRepository;
    ...
    void retryPublishesViaKafkaAndDeletesBufferOnSuccess() {
        bufferedMessageRepository.save(BufferedMessageTestData.entity(
                SOURCE_ID,
                API_KEY,
        ...
        bufferRetryScheduler.retryBufferedMessages();
    ...
    void retryKeepsBufferWhenKafkaIsRetryable() {
        BufferedMessageJpaEntity buffered = bufferedMessageRepository.save(BufferedMessageTestData.entity(
                SOURCE_ID,
                API_KEY,

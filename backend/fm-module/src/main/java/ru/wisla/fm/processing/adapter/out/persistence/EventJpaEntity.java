...
public class EventJpaEntity {
    ...
    /**
     * Only {@link EventJpaMapper} sets these three: an {@code id} makes {@code save} a merge rather
     * than a persist, and carrying the timestamps back means merging a mapped copy does not blank
     * them on the instance Hibernate already has in the session.
     */
    void setId(UUID id) {
        this.id = id;
    }

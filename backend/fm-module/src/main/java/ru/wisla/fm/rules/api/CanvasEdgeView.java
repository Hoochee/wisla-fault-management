...
/**
 * The edge projection {@link RuleCanvasValidator} walks, local to {@code rules} so this context no
 * longer imports {@code ru.wisla.fm.processing} (design decision D6).
 */

# architecture-hexagonal-processing

## Purpose

Hexagonal layout for the fm-module processing context (batch pipeline, rule engine domain services, ports), preserving dedup/threshold/correlation behavior and frozen console contracts.

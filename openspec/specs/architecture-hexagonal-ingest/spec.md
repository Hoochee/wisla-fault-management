# architecture-hexagonal-ingest

## Purpose

Hexagonal package layout and ports for adapter ingest and fm-module ingestion, preserving frozen HTTP/Kafka contracts, transaction boundaries, and Spring-free use-case tests.
